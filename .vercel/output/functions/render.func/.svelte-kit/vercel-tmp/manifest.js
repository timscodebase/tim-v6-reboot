export const manifest = {
	appDir: "_app",
	appPath: "_app",
	assets: new Set(["app.css","favicon/android-chrome-192x192.png","favicon/android-chrome-512x512.png","favicon/apple-touch-icon.png","favicon/favicon-16x16.png","favicon/favicon-32x32.png","favicon/favicon.ico","favicon.png","fonts/Prompt-Black.ttf","fonts/Prompt-BlackItalic.ttf","images/cursor.png","images/pointer.png","print.css","robots.txt","site.webmanifest","star.gltf","service-worker.js"]),
	mimeTypes: {".css":"text/css",".png":"image/png",".ico":"image/vnd.microsoft.icon",".ttf":"font/ttf",".txt":"text/plain",".webmanifest":"application/manifest+json",".gltf":"model/gltf+json"},
	_: {
