export const manifest = {
	appDir: "_app",
	appPath: "_app",
	assets: new Set(["favicon/android-chrome-192x192.png","favicon/android-chrome-512x512.png","favicon/apple-touch-icon.png","favicon/favicon-16x16.png","favicon/favicon-32x32.png","favicon/favicon.ico","favicon.png","fonts/Prompt-Black.ttf","fonts/Prompt-BlackItalic.ttf","images/cursor.png","images/pointer.png","site.webmanifest","star.gltf","service-worker.js"]),
	mimeTypes: {".png":"image/png",".ico":"image/vnd.microsoft.icon",".ttf":"font/ttf",".webmanifest":"application/manifest+json",".gltf":"model/gltf+json"},
	_: {
